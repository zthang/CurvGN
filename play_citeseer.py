...
with open("data/Citeseer/Citeseer/raw_old/ind.citeseer.allx", 'rb') as f:
    allx = pickle.load(f, encoding='latin1').A
with open("data/Citeseer/Citeseer/raw_old/ind.citeseer.tx", 'rb') as f:
    tx = pickle.load(f, encoding='latin1').A
with open("data/Citeseer/Citeseer/raw_old/ind.citeseer.graph", 'rb') as f:
